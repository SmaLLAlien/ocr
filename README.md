...
Портировано ядро Go-версии 1-в-1 по поведению: команды, флаги, env-переменные, формат `~/.opencodereview/config.json`, схема JSON-вывода и формат сессий JSONL совместимы. Промпты и правила ревью скопированы байт-в-байт.
